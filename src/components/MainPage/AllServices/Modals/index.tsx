  ...
  return (
    ...
    >
      ...
      <div>
        ...
        {title === "Eco cleaning" ? (
          <>
            <div style={{ marginBottom: "24px" }}>{renderText(2)}</div>
            <div style={{ marginBottom: "80px" }}>{renderEcoText()}</div>
            {renderGrid([7, 5, 5, 5])}
          </>
        ) : null}
        {title === "Post-construction" ? (
          <>
            <div style={{ marginBottom: "80px" }}>{renderText(2)}</div>
            <div style={{ marginBottom: "24px" }}>{renderGrid([5, 7])}</div>
            {renderBlock(4)}
          </>
        ) : null}
        {title === "Move in/out" ? (
          <>
            <div className="wrapper-title-text">
              ...
              <div
                className="wrapper-text in-line"
              ...
              >
                {[...new Array(2)].map((_, i) =>
                  !(i % 2) ? (
                    ...
                    <Writer
                      text={t(title + "_text_first_line_" + i)}
                      key={"Move_bold-line-" + i * 10}
                    />
                  )
                )}
                {[...new Array(2)].map((_, i) => (
                  <Writer
                    text={t(title + "_text_line_" + i)}
                    key={"Move_bold-line-" + i * 10}
                  />
                ))}
              </div>
        ...
        {title === "Ozonation" ? (
          <>
            ...
            <div style={{ marginBottom: "80px" }}>
              ...
              <div
                className="_flex _flex-row _justify-between hover-cards-mobile"
                style={{ marginBottom: "32px", gap: "21px" }}
              >
                {[
                  ...
                  <div
                    className="step-card ozonation-step"
                    style={{ width: "18%", height: "250px" }}
                  >
                    ...
                    <div className="hover-block">
                      <div className="hover-block-text">
                        {[...new Array(4)].map((_, j) => (
                          <Writer
                            text={t(title + "_text_hover_line_" + i + "_" + j)}
                            key={title + "_hover_" + j}
                          />
                        ))}
                      </div>
        ...
        {title === "In a last minute" ? (
          <>
            <div style={{ marginBottom: "80px" }}>{renderText(4)}</div>
            {renderGrid([7, 5, 5, 5])}
          </>
        ) : null}
        ...
        {title === "After party" ? (
          <>
            <div style={{ marginBottom: "80px" }}>{renderText()}</div>
            {renderGrid([7, 5, 5, 5])}
          </>
        ) : null}
              ...
              >
                {[...new Array(3)].map((_, i) =>
                  i % 2 ? (
                    ...
                    <Writer
                      text={t(title + "_text_" + i)}
                      key={"Deep-kitchen-line-" + i * 10}
                    />
                  )
                )}
                {[...new Array(2)].map((_, i) =>
                  i % 2 ? (
                    ...
                    <Writer
                      text={t(title + "_second_text_" + i)}
                      key={"Deep-kitchen-second-line-" + i * 10}
                    />
                  )
                )}
              </div>
                  ...
                  {[...new Array(4)].map((_, i) => (
                    <div key={"Deep-kitchen_list_block" + i * 100}>
                      {[...new Array(4)].map((_, j) => (
                        <div
                          className="wrapper-modal-reg-item"
                          key={"Deep-kitchen_list_block" + j * 100}
                        >
                          <div className="wrapper-modal-reg-item-text">
                            <Writer
                              text={t(title + "_text_list_" + i + "_" + j)}
                            />
                          </div>
                        </div>
                      ))}
        ...
        {title === "Airbnb" ? (
          <div className="wrapper-title-text">
            ...
            >
              <Writer
                text={t(title + "_text_first_line")}
                key={"Airbnb-first-line"}
              />
              {[...new Array(2)].map((_, i) =>
                i % 2 ? (
                  ...
                  <Writer
                    text={t(title + "_text_second_line_" + i)}
                    key={"Airbnb_bold-line-" + i * 10}
                  />
                )
              )}
              <Writer
                text={t(title + "_text_last_line")}
                key={"Airbnb-last-line"}
              />
            </div>
            <div className="wrapper-title" style={{ marginBottom: "32px" }}>
              <Writer text={t(title + "_second_title")} />
            ...
            <div
              className="_flex _flex-row _justify-between airbnb-mobile"
              style={{ gap: "21px" }}
            >
